...
const char *gengetopt_args_info_purpose = "PA project";

const char *gengetopt_args_info_usage = "Usage: ggo file [OPTION]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -f, --file=STRING  This parameter executes command lines indicated in the\n                       text file",
  "  -h, --no-help      This parameter prints a simple guide with all the avaible\n                       options",
  "  -m, --max=INT      This parameter applies the maximum number of command\n                       executions carried out by nanoShell",
  "  -s, --signalfile   This parameter creates the signal.txt file that contains\n                       commands that enable to sending signals to the nanoShell",
    0
};
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'f':	/* This parameter executes command lines indicated in the text file.  */
        ...
        case 'h':	/* This parameter prints a simple guide with all the avaible options.  */
          ...
          break;
        case 'm':	/* This parameter applies the maximum number of command executions carried out by nanoShell.  */
          ...
          break;
        case 's':	/* This parameter creates the signal.txt file that contains commands that enable to sending signals to the nanoShell.  */
